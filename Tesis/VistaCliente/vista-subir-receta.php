                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="formValidationExamples" class="row g-3" method="POST" action="./html/guardar-receta.php" enctype="multipart/form-data"> <!-- 1. Datos de la receta -->
                                <div class="col-12">
                                    <h6>1. Datos de la receta</h6>
                                    <hr class="mt-0" />
                                </div>
                                <div class="col-md-6"> <label class="form-label" for="titulo">Título</label> <input type="text" id="titulo" class="form-control" placeholder="Título" name="titulo" required /> </div>
                                <div class="col-md-6"> <label class="form-label" for="tiempo">Tiempo de preparación (HH:MM)</label> <input type="time" id="tiempo" class="form-control" placeholder="Tiempo de preparación" name="tiempo" required /> </div>
                                <div class="col-md-12"> <label class="form-label" for="descripcion">Descripción</label> <textarea id="descripcion" class="form-control" placeholder="Describe brevemente la receta" name="descripcion" rows="3" required></textarea> </div>
                                <div class="col-md-6"> <label class="form-label">Dificultad</label>
                                    <div class="form-check custom mb-2"> <input type="radio" id="dificultad-facil" name="dificultad" class="form-check-input" value="Fácil" checked /> <label class="form-check-label" for="dificultad-facil">Fácil</label> </div>
                                    <div class="form-check custom mb-2"> <input type="radio" id="dificultad-intermedio" name="dificultad" class="form-check-input" value="Intermedio" /> <label class="form-check-label" for="dificultad-intermedio">Intermedio</label> </div>
                                    <div class="form-check custom mb-2"> <input type="radio" id="dificultad-dificil" name="dificultad" class="form-check-input" value="Difícil" /> <label class="form-check-label" for="dificultad-dificil">Difícil</label> </div>
                                </div> <!-- Selector de Categorías -->
                                <div class="col-md-6"> <label class="form-label" for="categoria">Categorías</label>
                                    <div class="input-group mb-3"> <select class="form-select" id="categoria">
                                            <option selected disabled>Selecciona una categoría...</option> <?php include('conexion.php');
                                        ...
                                        </select> <button type="button" class="btn btn-outline-success" id="add-categoria-btn">Agregar Categoría</button> </div>
                                    <div id="selected-categorias"></div>
                                </div> <!-- 2. Instrucciones de la receta -->
                                <div class="col-12 mt-5">
                                    <h6>2. Instrucciones de la receta</h6>
                                    <hr class="mt-0" />
                                </div>
                                <div class="col-md-12"> <label class="form-label" for="instrucciones">Pasos</label>
                                    <div id="instrucciones-container">
                                        <div class="input-group mb-3"> <input type="number" class="form-control" name="num_pasos[]" placeholder="Número de paso" required /> <input type="text" class="form-control" name="pasos[]" placeholder="Descripción del paso" required /> <button class="btn btn-outline-success add-instruccion-btn" type="button">Agregar paso</button> </div>
                                    </div>
                                </div> <!-- 3. Ingredientes de la receta -->
                                <div class="col-12 mt-5">
                                    <h6 class="mt-2">3. Ingredientes de la receta</h6>
                                    <hr class="mt-0" />
                                </div>
                                <div class="col-md-12"> <label class="form-label" for="ingredientes">Ingredientes</label>
                                    <div id="ingredientes-container">
                                        <div class="input-group mb-3"> <input type="text" class="form-control" name="ingredientes[]" placeholder="Ingrediente" required /> <input type="text" class="form-control" name="cantidades[]" placeholder="Cantidad" required /> <button class="btn btn-outline-success add-ingrediente-btn" type="button">Agregar ingrediente</button> </div>
                                    </div>
                                </div> <!-- 4. Sube imágenes o videos de tu receta -->
                                <div class="col-12 mt-5">
                                    <h6 class="mt-2">4. Subir fotos o videos de la receta</h6>
                                    <hr class="mt-0" />
                                </div>
                                <div class="col-12"> <label class="form-label" for="media_files">Subir fotos o videos</label>
                                    <div class="input-group mb-3"> <label class="input-group-text" for="inputGroupFile01">Subir</label> <input type="file" class="form-control" id="inputGroupFile01" name="media_files[]" accept="image/*,video/*" multiple> </div>
                                </div>
                                <div class="col-12 justify-content-between"> <button type="submit" class="button button-contactForm btn_4 me-2">Subir receta</button> <a href="vista-perfil.php" class="btn btn-label-secondary">Cancelar</a> </div>
                            </form>
