...
$sql = "SELECT * FROM telefonos_usuarios WHERE ID_Telefono = '$id'";
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4">
                            <span class="text-muted fw-light">Admin / <a class="text-muted" href="./ListaEmpleados.php">Lista de Telefono /</a></span> Editar Telefono
                        </h4>
                        <div class="row">
                            <div class="col-md-12">

                                <div class="card mb-4">
                                    <h5 class="card-header">Datos del Telefono</h5>
                                    <!-- Account -->

                                    <hr class="my-0">
                                    <div class="card-body">

                                        <form class="mb-3" action="editar-Telefonos.php?id=<?php echo $fila["ID_Telefono"]; ?>" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                <!-- //!=========================================================================== -->
                                                <div class="mb-3 col-md-6">
                                                    <label for="username" class="form-label">Telefono</label>
                                                    <input type="text" class="form-control" name="telefono" value="<?php echo $fila['Telefono'] ?>" autofocus />
                                                </div>
                                            ...
                                            <div class="mt-2">
                                                <button type="submit" name="editar" class="btn btn-primary me-2">Editar Telefono</button>
                                                <a type="button" href="telefonos.php" class="btn btn-label-secondary">Descartar cambios</a>
                                            </div>
                                        </form>
                                    </div>
                                    <!-- /Account -->
