...
$sql = "SELECT * FROM img_usuarios WHERE ID_Usuario = $ID_Usuario;";
                        ...
                        <div class="card">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            <strong>Subir imagen <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-upload" viewBox="0 0 16 16">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <Form action="agregar_img_usuarios.php?id=<?php echo $ID_Usuario; ?>" method="post" enctype="multipart/form-data">

                                                <input type="text" class="form-control" name="nombre" placeholder="Nombre de la imagen" autofocus /><br>

                                                <input class="form-control" type="file"  name="imgFile" id="formFile"><br>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="card-header border-bottom">
                                    <h6 class="card-header">Fotos subidas: <?php echo mysqli_num_rows($resultado); ?></p>
                                    </h6>
                                ...
                                <div class="table-responsive text-nowrap">
                                    ...
                                    $sqlfot = "SELECT * FROM img_usuarios WHERE ID_Usuario = $ID_Usuario;";
                                    ...
                                    <table class="table-img">
                                        <tbody>
                                            ...
                                            ?>
                                                <td>
                                                    <img src="<?php echo $regfot[3]; ?>" alt="foto" height="400px" width="400px" class="img-fluid">
                                                    <p><?php echo $regfot[2]; ?></p>
                                                </td>
