...
$sql = "SELECT * FROM emails_usuarios WHERE ID_Email = '$id'";
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4">
                            <span class="text-muted fw-light">Admin / <a class="text-muted" href="./email.php">Lista de Email /</a></span> Editar Email
                        </h4>
                        <div class="row">
                            <div class="col-md-12">

                                <div class="card mb-4">
                                    <h5 class="card-header">Datos del Eail</h5>
                                    <!-- Account -->

                                    <hr class="my-0">
                                    <div class="card-body">

                                        <form class="mb-3" action="editar-email.php?id=<?php echo $fila["ID_Email"]; ?>" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                <!-- //!=========================================================================== -->
                                                <div class="mb-3 col-md-6">
                                                    <label for="username" class="form-label">Email</label>
                                                    <input type="text" class="form-control" name="Email" value="<?php echo $fila['Email'] ?>" autofocus />
                                                </div>
                                            ...
                                            <div class="mt-2">
                                                <button type="submit" name="editar" class="btn btn-primary me-2">Editar genero</button>
                                                <a type="button" href="email.php" class="btn btn-label-secondary">Descartar cambios</a>
                                            </div>
                                        </form>
                                    </div>
                                    <!-- /Account -->
