            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4">
                            <span class="text-muted fw-light">Admin / <a class="text-muted" href="./admin.php">Lista de Telefonos /</a></span> Registrar Telefonos
                        </h4>
                        <div class="row">
                            <div class="col-md-12">

                                <div class="card mb-4">
                                    <h5 class="card-header">Agregar Telefono</h5>
                                    <!-- Account -->

                                    <hr class="my-0">
                                    <div class="card-body">

                                        <form id="formAuthentication" class="mb-3" action="registrar-Telefonos.php" method="POST">
                                            <?php
                                            // Consulta para obtener el ID de usuario, nombre y apellido
                                            $query = "SELECT usu.ID_Usuario, per.Nombre, per.Apellido 
          FROM usuarios usu 
          INNER JOIN personas per ON usu.ID_Persona = per.ID_Persona";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="telefono" placeholder="Ingresá tú nombre" autofocus />
                                                </div>
                                                <!-- //!=========================================================================== -->


                                                <div class="mb-3 col-md-6">
                                                    <label for="username" class="form-label">Persona</label>
                                                    <select class="form-control" name="idUsuario" id="">
                                                        <?php
                                                        while ($opciones = mysqli_fetch_assoc($u)) {
                                                        ?>
                                                ...
                                                <div class="mt-2">
                                                    <button type="submit" name="registrar" class="btn btn-primary me-2">Registrar Telefono</button>
                                                    <a type="button" href="telefonos.php" class="btn btn-label-secondary">Cancelar</butaton>
                                                </div>
                                        </form>
                                    </div>
                                    <!-- /Account -->
