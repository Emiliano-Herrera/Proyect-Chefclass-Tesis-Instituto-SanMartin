...
$sql = "SELECT * FROM archivos WHERE usuario_ID = $ID_Usuario;";
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light">Mis archivos</span>
            </h4>
            <div class="card">
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                      <strong>Subir archivo <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-upload" viewBox="0 0 16 16">
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                      <Form action="subir-archivos.php" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-control" name="nombreArchivo" placeholder="Nombre del documento" autofocus /><br>

                        <input class="form-control" type="file" name="archivo" id="formFile"><br>

                        <button type="submit" name="subirArchivo" class="btn btn-primary">SUBIR</button>
              ...
              <div class="row mt-3">
                ...
                <div class="card-header border-bottom">
                  <h6 class="card-header">Archivos subidos: <?php echo mysqli_num_rows($resultado); ?></p>
                  </h6>
                  <h5 class="card-title">Tabla de tus archivos subidos</h5>
                </div>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      ?>
                        <tr>
                          <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $filas['nombre_documento'] ?></strong></td>
                          <td><?php echo $filas['fecha_subida'] ?></td>
                          <td><?php echo $filas['url'] ?></td>

                          <td>
                            <div class="dropdown">
                              <a type="button" class="btn btn-outline-primary" href="descargar-archivo.php?id=<?php echo $filas['id_archivos'] ?>"><i class="bi bi-download"></i></i> Descargar</a>

                              <a type="button" class="btn btn-outline-danger" href="eliminar-archivo.php?id=<?php echo $filas['id_archivos'] ?>"><i class="bx bx-trash me-1"></i> Eliminar</a>
