                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="formValidationExamples" class="row g-3" method="POST" action="guardar-receta.php" enctype="multipart/form-data"> <!-- 1. Datos de la receta -->
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 justify-content-between"> <button type="submit" class="btn btn-primary me-2">Subir receta</button> <a href="perfil.php" class="btn btn-label-secondary">Cancelar</a> </div>
                                        </form>
