            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4">
                            <span class="text-muted fw-light">Admin / <a class="text-muted" href="./admin.php">Lista de Emails /</a></span> Registrar Email
                        </h4>
                        <div class="row">
                            <div class="col-md-12">

                                <div class="card mb-4">
                                    <h5 class="card-header">Agregar Email</h5>
                                    <!-- Account -->

                                    <hr class="my-0">
                                    <div class="card-body">

                                        <form id="formAuthentication" class="mb-3" action="registrar-Email.php" method="POST">
                                            <?php
                                            // Suponiendo que ya tienes la conexión a la base de datos en $conexion
                                            $query = "SELECT usu.ID_Usuario, per.nombre FROM usuarios usu INNER JOIN personas per ON usu.ID_Persona = per.ID_Persona";
                                            $u = mysqli_query($conexion, $query);
                                            ?>
                                            <div class="row">
                                                <!-- //!=========================================================================== -->
                                                <div class="mb-3 col-md-6">
                                                    <label for="username" class="form-label">Email</label>
                                                    <input type="text" class="form-control" name="Email" placeholder="Ingresá el Email" autofocus />
                                                </div>
                                                <!-- //!=========================================================================== -->
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    $g = mysqli_query($conexion, "SELECT * FROM usuarios");

                                                    ?>
                                                    <select class="form-select" name="nombreUsu" id="nombreUsu" required>
                                                        <?php
                                                        while ($opciones = mysqli_fetch_row($g)) {
                                                        ?>
                                                            <option value="<?php echo $opciones[0] ?>"><?php echo $opciones[2] ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
                                                ...
                                                <div class="mt-2">
                                                    <button type="submit" name="registrar" class="btn btn-primary me-2">Registrar Email</button>
                                                    <a type="button" href="email.php" class="btn btn-label-secondary">Cancelar</butaton>
                                                </div>
                                        </form>
                                    </div>
                                    <!-- /Account -->
