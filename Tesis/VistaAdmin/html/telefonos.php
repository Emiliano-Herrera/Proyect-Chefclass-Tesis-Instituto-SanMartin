    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                $totalResultados = $conexion->query("SELECT COUNT(*) as total FROM telefonos_usuarios")->fetch_assoc()['total'];
                ...
                // Añade la condición WHERE para filtrar por el numero de telefono
                $whereCondition = !empty($term) ? "WHERE telefono LIKE '%$term%' " : '';

                $sql = "SELECT *
                        FROM usuarios usu
                        INNER JOIN personas per ON usu.ID_Persona = per.ID_Persona
                        INNER JOIN telefonos_usuarios tu ON usu.ID_Usuario = tu.ID_Usuario
                ...
                if (isset($_GET['search'])) {
                    if (empty($term)) {
                        ...
                        echo "<script>alert('Por favor ingresa un numero de telefono para buscar.'); window.location.href='telefonos.php';</script>";
                        exit;
                    } elseif ($result->num_rows == 0) {
                        // Si no se encontraron resultados
                        echo "<script>alert('No se encontró ningún telefono con ese numero.'); window.location.href='telefonos.php';</script>";
                        exit;
                    }
                }
                ...
                ?>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="py-3 mb-4">
                                <span class="text-muted fw-light">Admin /</span> Lista de Telefonos de Usuarios
                            </h4>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header border-bottom">
                                    ...
                                    <h6 class="card-title">Añadir un Telefono</h6>
                                    <a href="./vista-registrar-telefono.php" class="btn btn-success">Añadir <i class="bi bi-person-add"></i></a>
                                    <br>
                                    <hr>
                                    <h6 class="card-title">Buscar Telefono</h6>
                                    <form action="" method="GET" class="row g-3">
                                        <div class="col-auto">
                                            <input type="text" name="search" id="search" class="form-control mx-2" placeholder="Numero de telefono">
                                        ...
                                        <?php if (isset($_GET['search']) && !empty($_GET['search'])): ?>
                                            <div class="col-auto">
                                                <a href="telefonos.php" class="btn btn-info">Ver todos</a>
                                            </div>
                                        <?php endif; ?>
                                    </form>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="PerfilTelefonos.php?ID_Persona=<?php echo $row['ID_Telefono']; ?>"><i class="bi bi-eye-fill me-1"></i>ver detalle</a>
                                                                <a class="dropdown-item" href="vista-editar-Telefonos.php?Id=<?php echo $row['ID_Telefono'] ?>"><i class="bx bx-edit-alt me-1"></i>Editar</a>
                                                                <a class="dropdown-item" href="eliminar-Telefonos.php?id=<?php echo $row['ID_Telefono'] ?>"><i class="bx bx-trash me-1"></i> Eliminar</a>
                                                                <!--<a class="dropdown-item" href="deshabilitado-Telefonos.php?id=<?php echo $row['ID_Telefono'] ?>"><i class='bx bx-block'></i> Desabilitar</a>-->
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                ...
                <?php
                    ...
                    echo "<tr><td colspan='6'>No se encontraron telefonos en la base de datos.</td></tr>";
                }
