...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4">
                            <span class="text-muted fw-light">Administración / <a class="text-muted" href="roles.php">Roles /</a></span> Editar Rol
                        </h4>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="formEditarRol" class="mb-3" action="editar-rol.php?id=<?php echo $fila['id_rol']; ?>" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    <label for="username" class="form-label">Nombre</label>
                                                    <input type="text" class="form-control" name="nombre" value="<?php echo $fila['nombre_rol']; ?>" autofocus />
                                                </div>
                                            </div>
                                            <div class="mt-2">
                                                <button type="button" id="editar-rol-btn" class="btn btn-primary me-2">Editar Rol</button>
                                                <a type="button" href="roles.php" class="btn btn-label-secondary">Descartar cambios</a>
                                            </div>
                                        </form>
    ...
    <script>
        $(document).ready(function() {
            $('#editar-rol-btn').on('click', function() {
                ...
                if (nombre === '') {
                    ...
                    Swal.fire({
                        title: `¿${usuario}, de verdad quieres editar el rol a "${nombre}"?`,
