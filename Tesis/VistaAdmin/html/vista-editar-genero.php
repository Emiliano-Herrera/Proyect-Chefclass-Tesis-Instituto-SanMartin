            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="admin.php" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2"><img src="../../VistaCliente/img/chefclassFinal.png" alt="Logo" width="150"></span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    $recetas_activos = [
                        'vista-editar-genero.php',
                        'vista-registrar-genero.php'
                    ];
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4">
                            <span class="text-muted fw-light">Administración / <a class="text-muted" href="generos.php">Géneros /</a></span> Editar Género
                        </h4>
                        <div class="row">
                            <div class="col-md-12">

                                <div class="card mb-4">
                                    <h5 class="card-header">Datos del genero</h5>
                                    <!-- Account -->
                                        ...
                                        <form id="formEditGenero" class="mb-3" method="POST">
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingresá el género" value="<?php echo $fila['nombre_genero'] ?>" pattern="[A-Za-zÁÉÍÓÚáéíóúñÑ\s]+" title="Solo se permiten letras" required />
                                                </div>
                                                <div class="d-flex justify-content-center pt-3">
                                                    <button type="button" id="editar-genero-btn" class="btn btn-primary me-2">Editar Género</button>
                                                    <a href="generos.php" class="btn btn-label-danger suspend-user">Cancelar y volver</a>
                                                </div>
                                            </div>
                    ...
                    <script>
                        ...
                        function validarFormularioGenero(event) {
                            ...
                            const generoID = <?php echo json_encode($fila['id_genero']); ?>;
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    fetch('comprobar-genero.php', {
                                        ...
                                        if (data.exists) {
                                            ...
                                            fetch(`editar-genero.php?id=${generoID}`, {
                                                method: 'POST',
                                                body: formData
                                            }).then(response => response.json()).then(data => {
                                                if (data.status === 'success') {
                                                    Swal.fire({
                                                        title: 'Éxito',
                                                        text: `${usuario} ha editado correctamente el género "${nombre}".`,
                                                        icon: 'success'
                                                    }).then(() => {
                                                ...
                                                Swal.fire({
                                                    icon: 'error',
                                                    title: 'Error',
                                                    text: 'Hubo un problema al editar el género. Intente nuevamente.'
                                                });
                                            });
                                        }
                                    }).catch(error => {
                                        Swal.fire({
                                            icon: 'error',
                                            title: 'Error',
                                            text: 'Hubo un problema al comprobar el género. Intente nuevamente.'
                                        });
                                    });
                                }
                            });
